<?xml version="1.0" encoding="ISO-8859-1"?>
   <StyledLayerDescriptor version="1.0.0"
     ...
     <NamedLayer>
       ...
       <UserStyle>
         <Title>Heatmap</Title>
         <Abstract>A heatmap surface showing request density</Abstract>
         <FeatureTypeStyle>
           <Transformation>
             <ogc:Function name="gs:Heatmap">
               ...
               <ogc:Function name="parameter">
                 <ogc:Literal>rasterizeMode</ogc:Literal>
                 <ogc:Literal>envelope</ogc:Literal>
               </ogc:Function>
               <ogc:Function name="parameter">
                 <ogc:Literal>normalizeMinimum</ogc:Literal>
          ...
          <Rule>
            ...
            <!-- specify geometry attribute to pass validation -->
              <Geometry>
                <ogc:PropertyName>BOX</ogc:PropertyName></Geometry>
              <Opacity>0.6</Opacity>
              <ColorMap type="ramp" >
